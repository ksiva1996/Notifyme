...
class workersignup extends AsyncTask<String,String,String> {
    private String username;
    private Context context;
    workersignup (Context con)
    {
        this.context=con;
    }
        ...
        if(s!=null) {
            try {
                ...
                if (x == 1) {
                    ...
                    bundle.putString("current_username", username);
                    i.putExtras(bundle);
    ...
    protected String doInBackground(String... params) {
        ...
        String result=null;
        try {
            url = new URL("http://mstmnit.com/leagueofshadows/pingme/register.php");
